...
public class HttpDemoServerHandler extends SimpleChannelInboundHandler<HttpObject> {
	...
	public void messageReceived(ChannelHandlerContext ctx, HttpObject msg) throws Exception {
		...
		if (msg instanceof HttpRequest) {
	        ...
	        System.out.println(CRequest.UrlPage(uri.toString()));
	        System.out.println(CRequest.UrlPage(uri.toString()).substring(1));
	        //url参数键值对
	        Map<String, String> mapRequest = CRequest.URLRequest(uri.toString());
