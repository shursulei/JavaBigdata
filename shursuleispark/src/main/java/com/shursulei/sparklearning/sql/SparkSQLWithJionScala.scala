package com.shursulei.sparklearning.sql
...
object SparkSQLWithJionScala {
  ...
  def main(args: Array[String]): Unit = {
        ...
        val personScoreDS = sqlContext.read.json("D://scalaeclipse//sparkworkspace//scalaspark//resource//score.json")
       //将成绩表注册为临时表
      ...
      personDS.show()
      personDS.write.json("D://scalaeclipse//sparkworkspace//scalaspark//resource//json")
    }
}