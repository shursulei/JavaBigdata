package com.shursulei.sparklearning;
...
public class Cogroups {
	public static void main(String[] args) {
		...
		JavaPairRDD<Integer, Tuple2<Iterable<String>, Iterable<Integer>>> cogroup = (JavaPairRDD<Integer, Tuple2<Iterable<String>, Iterable<Integer>>>) name.cogroup(score);
