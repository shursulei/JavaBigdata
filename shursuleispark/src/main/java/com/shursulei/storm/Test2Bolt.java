...
public class Test2Bolt extends BaseRichBolt {
	...
	*/
	...
	/**
	 * 在Bolt启动前执行，提供Bolt启动环境配置的入口 一般对于不可序列化的对象进行实例化。 注:如果是可以序列化的对象，那么最好是使用构造函数。
	 */
	...
	/**
	 * cleanup是IBolt接口中定义,用于释放bolt占用的资源。 Storm在终止一个bolt之前会调用这个方法。
	 */
	public void cleanup() {
